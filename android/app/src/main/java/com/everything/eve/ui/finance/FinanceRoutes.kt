...
object FinanceRoutes {
    ...
    // ============================================================================
    // B5 汇率包导入 / 默认币种设置（stage5-finance-v2 / FR-V2-C.2）
    // ============================================================================
    // 当前 FinanceScreen 不使用 NavHost（tab + 编辑器全屏切换模式），该常量仅作
    // 路由语义锚点与后续主导航接入预留；设置屏通过 settingsMode 全屏承载。
    // ============================================================================

    /** B5 汇率包导入 / 默认币种设置屏路由常量。 */
    const val RATES_IMPORT = "finance_rates_import"

    // ============================================================================
    // Task 8 投资行情包导入 / 同步 URL 设置（stage5-finance-v2 / FR-V2-D.2 / FR-V2-D.3）
    // ============================================================================
    // 与 RATES_IMPORT 同款镜像：quotesMode 全屏承载；NavHost 接入预留常量。
    // ============================================================================

    /** Task 8 投资行情包导入 / 同步 URL 设置屏路由常量。 */
    const val QUOTES_IMPORT = "finance_quotes_import"
